...
# GLM-4.7-Flash Server Startup Script (Q8_K_XL version)
...
MODEL_PATH="models/GLM-4.7-Flash-UD-Q8_K_XL.gguf"
...
echo "=========================================="
echo "GLM-4.7-Flash Server (Q8_K_XL)"
echo "=========================================="
echo "Model: $MODEL_PATH"
echo "Quantization: 8-bit (higher quality)"
echo "Port: 11346"
