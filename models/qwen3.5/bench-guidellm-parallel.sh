#!/bin/bash
# GuideLLM parallel benchmarking for vLLM Qwen3.5-35B-A3B-FP8
...
TARGET="${TARGET:-http://localhost:11435}"
MODEL="${MODEL:-qwen3.5-35b}"
PROCESSOR="${PROCESSOR:-Qwen/Qwen3.5-35B-A3B-FP8}"
...
main() {
  echo ""
  log "╔══════════════════════════════════════════════════════════════╗"
  log "║  GuideLLM Parallel Benchmark — vLLM Qwen3.5-35B-A3B-FP8   ║"
